...
public class RandomSuffixFactory {
	...
	/**
	 * Returns a unique suffix for any given token name. In case all 256
	 * possible values have been used up it will simply start over.
	 *
	 * @param tokenName is used to check if a suffix has already been generated
	 *            for that name
	 * @return a suffix in the range of 1 to 256
	 */
	 ...
	 * suffix values in random order, and an index.
	 */
