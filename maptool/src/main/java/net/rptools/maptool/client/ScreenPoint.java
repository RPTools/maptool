...
public class ScreenPoint extends Point2D.Double {
	...
	/**
	 * Translate the point from screen x,y to the nearest top left corner of a zone x,y for when the zone point required is on the "zone point grid" as opposed to the area of zone space designated by
	 * the zone point.
	 */
