...
public class JSONMacroFunctions extends AbstractFunction {
			...
			if (parameters.size() > 2) {
				...
				for (Object o : parameters.subList(2, parameters.size())) {
					if (o instanceof String)
						...
						throw new ParserException(I18N.getText("macro.function.json.unknownType", o == null ? "NULL" : o.toString(), functionName));
				}
				return JSONSort(asJSON(parameters.get(0)), parameters.size() > 1 ? parameters.get(1).toString() : "ascending", fields);
			} else {
	...
	private JSONArray JSONSort(Object jsonArray, String direction, List<String> fields) throws ParserException {
		if (!(jsonArray instanceof JSONArray)) {
	 ...
	 *            the direction, ascending or descending to sort the array.
	 * @param fields
	 *            the fields to base the sort on.
	 * @return The sorted array.
	 * @throws ParserException
	 *             when an error occurs.
	 */
	private JSONArray JSONSortObjects(JSONArray jsonArray, String direction, List<String> fields) throws ParserException {
		for (Object o : jsonArray) {
			if (!(o instanceof JSONObject)) {
				throw new ParserException(I18N.getText("macro.function.json.arrayMustContainObjects", o.toString()));
			}
		}
		boolean ascending = true;
		if (direction.toLowerCase().startsWith("d")) {
	 ...
	 * @param key
	 *            The key for the object or index for the array.
	 * @return the value.
	 * @throws ParserException
	 */
	 ...
	 * @param delim
	 *            The delimiter used in the string property.
	 * @return The string property of the object.
	 * @throws ParserException
	 *             If the object is not a JSON object.
	 */
	 ...
	 *            The object to convert.
	 * @param delim
	 *            The delimiter used in the string list.
	 ...
	 * 
	 * @param obj
	 *            The object to get the fields of.
	 * @param delim
	 *            The delimiter used in the string list.
	 * @return The string property of the object.
	 * @throws ParserException
	 ...
	 * @throws ParserException
	 *             if the obj is not a JSON object.
	 */
	 ...
	 *            The string list.
	 * @param delim
	 *            The delimiter used to separate items in the string list.
	 * @return The JSON Array.
	 */
	 ...
	 * @param delim
	 *            The delimiter used to separate items in the list.
	 ...
	 * @throws ParserException
	 *             if obj can not be converted to a JSON object.
	 */
	 ...
	 * 
	 * @param obj
	 *            The JSON string to ident.
	 * @param indent
	 *            The indention factor.
	 * @return The indented string.
	 * @throws ParserException
	 *             If an error occurs parsing the JSON String.
	 */
	...
	private static class JSONObjectComparator implements Comparator<Object> {
		...
		public JSONObjectComparator(boolean ascending, List<String> fields, List<Comparator<Object>> comparators) {
			this.ascending = ascending;
			this.fields = fields;
