...
public class IsometricGridTest {
  ...
  @ParameterizedTest
  @DisplayName("Test IsometricGrid.nextFacing(…)")
  @CsvFileSource(resources = "IsometricGrid.nextFacing.csv", useHeadersInDisplayName = true)
  void testNextFacing(
  ...
  @ParameterizedTest
  @DisplayName("Test IsometricGrid.nearestFacing(…)")
  @CsvFileSource(resources = "IsometricGrid.nearestFacing.csv", useHeadersInDisplayName = true)
