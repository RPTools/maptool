...
public class SquareGridTest {
  ...
  @ParameterizedTest
  @DisplayName("Test SquareGrid.nextFacing(…)")
  @CsvFileSource(resources = "SquareGrid.nextFacing.csv", useHeadersInDisplayName = true)
  void testNextFacing(
  ...
  @ParameterizedTest
  @DisplayName("Test SquareGrid.nearestFacing(…)")
  @CsvFileSource(resources = "SquareGrid.nearestFacing.csv", useHeadersInDisplayName = true)
