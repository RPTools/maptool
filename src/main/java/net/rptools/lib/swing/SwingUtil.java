...
public class SwingUtil {
    ...
    /**
     * Centers the innerWindow over the outerWindow. Basically, this method finds the centerpoint of the <code>outerWindow</code> and sets the location of <code>innerWindow</code> so that it's center
     * is coincident with <code>outerWindow</code>'s center.
     * 
     * @param innerWindow
     *            window to move
     * @param outerWindow
