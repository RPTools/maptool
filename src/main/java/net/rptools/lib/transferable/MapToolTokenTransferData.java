...
/**
 * A list of token transfer data that came from the Map Tool. Need to specify app in the class so
...
public class MapToolTokenTransferData extends ArrayList<TokenTransferData> {
  ...
  public static final DataFlavor MAP_TOOL_TOKEN_LIST_FLAVOR =
      new DataFlavor(MapToolTokenTransferData.class, "Map Tool Token List");
}
