...
public class AssetConsumer {
	...
	/**
	 * Create a new asset consumer, it will prepare a place to receive the incoming data chunks. When complete the resulting file can be found at getFilename()
	 * 
	 * @param destinationDir
	 *            - location to store the incoming file
	 * @param header
	 *            - from the corresponding AssetProducer
	 */
	 ...
	 * 
	 * @param chunk
	 *            produced from the corresponding AssetProducer
	 * @throws IOException
	 */
