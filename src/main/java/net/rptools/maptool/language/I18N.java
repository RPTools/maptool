...
public class I18N {
     ...
     * text that can appear in the properties file that means "use
     * menuShortcutKey"? But what text should that be? And can it be
     ...
     * mnemonic. So for the key <b>action.loadMap</b> that has the value "&Load
     * Map" in the properties file, this method returns "Load Map".
     * 
     * @param key
     *            the component to search for
