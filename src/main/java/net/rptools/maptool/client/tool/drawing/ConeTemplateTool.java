 ...
 * set the radius. Use control and mouse position to direct the cone. This allows the user to move the entire template where it is to be used before placing it which is very important when casting a
 * spell.
 * 
 * @author jgorrell
