...
/**
 * Annotation that is used to tell the JavaScript engine the name of the variable that an object of this class will be bound to to provide the API functionality. Only objects that need to have a
