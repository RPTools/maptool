...
import main.java.net.rptools.maptool.model.TokenProperty;
import main.java.net.rptools.maptool.util.FunctionUtil;
import main.java.net.rptools.parser.ParserException;
import main.java.net.rptools.parser.VariableModifiers;
import main.java.net.rptools.parser.VariableResolver;
