...
public class TokenPropertiesManagementPanelView {
  ...
  private void $$$setupUI$$$() {
    ...
    table1.setName("propertiesTable");
    ...
    this.$$$loadLabelText$$$(
        ...
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "TokenPropertiesPanel.label.type"));
    mainPanel.add(
        label1,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        button5,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "TokenPropertiesPanel.button.setAsDefault"));
    mainPanel.add(
        button5,
        new GridConstraints(
            4,
    ...
    this.$$$loadLabelText$$$(
        label2, this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.name"));
    mainPanel.add(
        label2,
        new GridConstraints(
            2,
    ...
    this.$$$loadLabelText$$$(
        label3,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "TokenPropertiesPanel.label.statSheet"));
    mainPanel.add(
        label3,
        new GridConstraints(
            5,
    ...
    button6.setActionCommand("MovePropertyUp");
    button6.setName("propertyMoveUpButton");
    this.$$$loadButtonText$$$(
        button6, this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Button.up"));
    panel2.add(
        button6,
        new GridConstraints(
            0,
    ...
    button7.setActionCommand("MovePropertyDown");
    button7.setName("propertyMoveDownButton");
