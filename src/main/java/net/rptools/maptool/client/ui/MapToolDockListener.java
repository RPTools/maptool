 ...
 * 
 * Because rendering of the Selection and Impersonate panels is now suppressed when they are not visible (to improve performance) this class resets those panels when they become visible (so that the
 * user sees a seamless transition and does not have to select the token again to get the selection / impersonate panels to populate).
 * 
 * @author Rumble
 * 
 */
