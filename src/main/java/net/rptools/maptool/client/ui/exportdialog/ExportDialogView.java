  ...
  private void $$$setupUI$$$() {
    ...
    this.$$$loadLabelText$$$(
        ...
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "action.exportScreenShot.title"));
    mainPanel.add(
        label1,
        new GridConstraints(
            0,
    ...
    tabbedPane1.addTab(
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.filesystem2"),
        panel1);
    final JLabel label2 = new JLabel();
    this.$$$loadLabelText$$$(
        label2,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.location"));
    panel1.add(
        label2,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label3,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.ftp.host.example"));
    panel2.add(
        label3,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label4,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.ftp.username.example"));
    panel2.add(
        label4,
        new GridConstraints(
            1,
    ...
    this.$$$loadLabelText$$$(
        label5,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.ftp.path.example"));
    panel2.add(
        label5,
        new GridConstraints(
            3,
    ...
    this.$$$loadLabelText$$$(
        label6, this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.host"));
    panel2.add(
        label6,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label9,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.pathfilename"));
    panel2.add(
        label9,
        new GridConstraints(
            3,
    ...
    this.$$$loadLabelText$$$(
        label10,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.ftp.path.note"));
    panel2.add(
        label10,
        new GridConstraints(
            4,
    ...
    tabbedPane1.addTab(
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.advanced"),
        panel3);
    ...
    this.$$$loadButtonText$$$(
        radioButton1,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.method.iw"));
    radioButton1.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.method.iw.tooltip"));
    panel3.add(
        radioButton1,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        radioButton2,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.method.bg"));
    radioButton2.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.method.bg.tooltip"));
    panel3.add(
        radioButton2,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label11,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.method.label"));
    panel3.add(
        label11,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        radioButton3,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.method.buffered"));
    radioButton3.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.method.buffered.tooltip"));
    panel3.add(
        radioButton3,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label12,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "dialog.NewToken.type"));
    panel4.add(
        label12,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        radioButton4,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.view.current"));
    panel4.add(
        radioButton4,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        radioButton5,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.entiremap"));
    radioButton5.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.entiremap.tooltip"));
    panel4.add(
        radioButton5,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label13,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.layers"));
    panel4.add(
        label13,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        checkBox1,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.token"));
    checkBox1.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.layer.tooltip"));
    panel4.add(
        checkBox1,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        checkBox2,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "panel.MapExplorer.View.GM"));
    ...
    this.$$$loadButtonText$$$(
        checkBox3,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "panel.MapExplorer.View.OBJECTS"));
    ...
    this.$$$loadButtonText$$$(
        checkBox4,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "panel.MapExplorer.View.BACKGROUND"));
    ...
    this.$$$loadButtonText$$$(
        checkBox5,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.board"));
    checkBox5.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.board.tooltip"));
    panel4.add(
        checkBox5,
        new GridConstraints(
            4,
    ...
    this.$$$loadButtonText$$$(
        checkBox6,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Button.fog"));
    checkBox6.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.fog.tooltip"));
    panel4.add(
        checkBox6,
        new GridConstraints(
            1,
    ...
    this.$$$loadButtonText$$$(
        checkBox7,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.visibility"));
    checkBox7.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.layer.vbl.tooltip"));
    panel4.add(
        checkBox7,
        new GridConstraints(
            2,
    ...
    this.$$$loadButtonText$$$(
        radioButton6,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "userTerm.Player"));
    radioButton6.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.player.tooltip"));
    panel4.add(
        radioButton6,
        new GridConstraints(
            4,
    ...
    radioButton7.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.gm.tooltip"));
    panel4.add(
        radioButton7,
        new GridConstraints(
            4,
    ...
    this.$$$loadLabelText$$$(
        label14,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.view"));
    panel4.add(
        label14,
        new GridConstraints(
            4,
    ...
    this.$$$loadButtonText$$$(
        radioButton8,
        this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Label.view.current"));
    radioButton8.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.current.tooltip"));
    panel4.add(
        radioButton8,
        new GridConstraints(
            2,
    ...
    this.$$$loadButtonText$$$(
        radioButton9,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.asselected"));
    radioButton9.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "ExportScreenshot.view.asselected.tooltip"));
    panel4.add(
        radioButton9,
        new GridConstraints(
            2,
