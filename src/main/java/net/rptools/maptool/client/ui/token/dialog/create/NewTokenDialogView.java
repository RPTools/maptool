...
public class NewTokenDialogView {
  ...
  private void $$$setupUI$$$() {
    ...
    this.$$$loadButtonText$$$(
        checkBox1,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "dialog.NewToken.show"));
    mainPanel.add(
        checkBox1,
        new GridConstraints(
            11,
    ...
    this.$$$loadLabelText$$$(
        label5,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "dialog.NewToken.visible"));
    mainPanel.add(
        label5,
        new GridConstraints(
            8,
    ...
    this.$$$loadLabelText$$$(
        label8,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "dialog.NewToken.statSheet"));
    mainPanel.add(
        label8,
        new GridConstraints(
            5,
    ...
    this.$$$loadLabelText$$$(
        label9,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "dialog.NewToken.statSheetLocation"));
    mainPanel.add(
        label9,
        new GridConstraints(
            6,
    ...
    this.$$$loadLabelText$$$(
        label10,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "dialog.NewToken.tokenPropertyType"));
    mainPanel.add(
        label10,
        new GridConstraints(
            4,
