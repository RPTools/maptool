...
public class MacroButtonDialog extends JDialog implements SearchListener {
    ...
    private void installColorCombo() {
        ...
        combo.setModel(new DefaultComboBoxModel<String>((String[]) MapToolUtil.getColorNames().toArray()));
     ...
     *
     * <p>
     * This is trickier than it sounds as macOS doesn't automatically merge the per-window menu bar
     * that this method used to create to the top-of-the-screen menu bar that is the stock in trade
     * on macOS. So in order to create a portable method that works everywhere, we retrieve the
