...
public class HTMLWebViewManager {
  ...
  public class JavaBridge {
    ...
    /**
     * Receives an added node sent by the JS Mutation Observer and attaches an event listener to it and its
     * descendants, if need be. The elements affected are Anchors, Areas, Forms, Buttons, and Inputs.
     *
