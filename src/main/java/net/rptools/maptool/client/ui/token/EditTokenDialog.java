...
public class EditTokenDialog extends AbeillePanel<Token> {
  ...
  public boolean commit() {
    ...
    // VBL
    token.setTopology(Zone.TopologyType.WALL_VBL, getTokenVblPanel().getTokenVBL_optimized());
    ...
    if (getTokenVblPanel().getAutoGenerated()) {
      token.setColorSensitivity(
          Zone.TopologyType.WALL_VBL, getTokenVblPanel().getColorSensitivity());
    } else {
      token.setColorSensitivity(Zone.TopologyType.WALL_VBL, -1);
    }
            ...
            e -> {
              if (getTokenVblPanel().getTokenVBL_optimized() != null) {
                ...
                TokenVBL.renderTopology(
                    ...
                    getTokenVblPanel()
                        .getToken()
                        .getTransformedTopology(getTokenVblPanel().getTokenVBL_optimized()),
                    false,
