...
public class EditTokenDialog extends AbeillePanel<Token> {
  ...
  public void bind(final Token token) {
    ...
    getIsTerrainButton().setSelected(token.getIsTerrainVbl());
  ...
  public boolean commit() {
    ...
    token.setIsTerrainVBL(getIsTerrainButton().isSelected());
  ...
  public JCheckBox getIsTerrainButton() {
    return (JCheckBox) getComponent("isTerrainButton");
  }
