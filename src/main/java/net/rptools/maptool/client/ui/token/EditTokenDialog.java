...
public class EditTokenDialog extends AbeillePanel<Token> {
    ...
    private static final ImageIcon REFRESH_ICON_ON = new ImageIcon(EditTokenDialog.class.getClassLoader().getResource("net/rptools/maptool/client/image/refresh_arrows_small.png"));
    private static final ImageIcon REFRESH_ICON_OFF = new ImageIcon(EditTokenDialog.class.getClassLoader().getResource("net/rptools/maptool/client/image/refresh_off_arrows_small.png"));
    ...
    public void initVblPreviewPanel() {
        ...
        getAutoGenerateVblButton().addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                vblPanel.setTokenVBL(TokenVBL.createVblArea(vblPanel.getToken(), (int) getAlphaSensitivitySpinner().getValue()));
