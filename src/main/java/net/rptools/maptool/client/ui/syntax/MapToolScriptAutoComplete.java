...
public class MapToolScriptAutoComplete {
	...
	private static final ResourceBundle MACRO_DESCRIPTIONS_BUNDLE = ResourceBundle.getBundle("net.rptools.maptool.language.macro_descriptions.i18n");
	...
	public MapToolScriptAutoComplete() {
		for (String macro : MapTool.getParser().listAllMacroFunctions())
			provider.addCompletion(new BasicCompletion(provider, macro, getShortDescription(macro), getSummary(macro)));
