...
public class MapPropertiesDialogView {
  ...
  private void $$$setupUI$$$() {
    ...
    this.$$$loadLabelText$$$(
        label6,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "MapPropertiesDialog.label.lightingStyle"));
    label6.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n",
            "MapPropertiesDialog.label.lightingStyle.tooltip"));
    panel1.add(
        label6,
        new GridConstraints(
            8,
    ...
    label7.setIcon(
        new ImageIcon(getClass().getResource("/net/rptools/maptool/client/image/gridSquare.png")));
    ...
    label8.setIcon(
        new ImageIcon(
            getClass().getResource("/net/rptools/maptool/client/image/gridVerticalHex.png")));
    ...
    label9.setIcon(
        new ImageIcon(
            getClass().getResource("/net/rptools/maptool/client/image/gridHorizontalHex.png")));
    ...
    label10.setIcon(
        new ImageIcon(getClass().getResource("/net/rptools/maptool/client/image/cross.png")));
    ...
    label11.setIcon(
        new ImageIcon(
            getClass().getResource("/net/rptools/maptool/client/image/gridIsometric.png")));
    ...
    this.$$$loadLabelText$$$(
        label12, this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "Grid.size"));
