...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel2.setLayout(new FormLayout("fill:d:noGrow,fill:d:noGrow", "center:d:noGrow"));
        ...
        panel2.add(radioButton1, cc.xy(1, 1));
        final ImageComponent imageComponent1 = new ImageComponent();
        Font imageComponent1Font = UIManager.getFont("Panel.font");
        if (imageComponent1Font != null) imageComponent1.setFont(imageComponent1Font);
        imageComponent1.setName("squareIcon");
        panel2.add(imageComponent1, cc.xy(2, 1));
        final JPanel panel3 = new JPanel();
        panel3.setLayout(new FormLayout("fill:d:noGrow,fill:d:noGrow", "center:d:noGrow"));
        ...
        panel3.add(radioButton2, cc.xy(1, 1));
        final ImageComponent imageComponent2 = new ImageComponent();
        Font imageComponent2Font = UIManager.getFont("Panel.font");
        if (imageComponent2Font != null) imageComponent2.setFont(imageComponent2Font);
        imageComponent2.setName("hexVertIcon");
        panel3.add(imageComponent2, cc.xy(2, 1));
        final JPanel panel4 = new JPanel();
        panel4.setLayout(new FormLayout("fill:d:noGrow,fill:d:noGrow", "center:d:noGrow"));
        ...
        panel4.add(radioButton3, cc.xy(1, 1));
        final ImageComponent imageComponent3 = new ImageComponent();
        Font imageComponent3Font = UIManager.getFont("Panel.font");
        if (imageComponent3Font != null) imageComponent3.setFont(imageComponent3Font);
        imageComponent3.setName("hexHoriIcon");
        panel4.add(imageComponent3, cc.xy(2, 1));
        final JPanel panel5 = new JPanel();
        panel5.setLayout(new FormLayout("fill:d:noGrow,fill:d:noGrow", "center:d:noGrow"));
        ...
        panel5.add(radioButton4, cc.xy(1, 1));
        final ImageComponent imageComponent4 = new ImageComponent();
        Font imageComponent4Font = UIManager.getFont("Panel.font");
        if (imageComponent4Font != null) imageComponent4.setFont(imageComponent4Font);
        imageComponent4.setName("noGridIcon");
        imageComponent4.setToolTipText(this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "MapPropertiesDialog.image.nogrid"));
        panel5.add(imageComponent4, cc.xy(2, 1));
        final JPanel panel6 = new JPanel();
        panel6.setLayout(new FormLayout("fill:d:noGrow,fill:d:noGrow", "center:d:noGrow"));
        ...
        panel6.add(radioButton5, cc.xy(1, 1));
        final ImageComponent imageComponent5 = new ImageComponent();
        Font imageComponent5Font = UIManager.getFont("Panel.font");
        if (imageComponent5Font != null) imageComponent5.setFont(imageComponent5Font);
        imageComponent5.setName("isoIcon");
        panel6.add(imageComponent5, cc.xy(2, 1));
        final JLabel label6 = new JLabel();
        this.$$$loadLabelText$$$(label6, this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "MapPropertiesDialog.label.cell.pixels"));
        panel1.add(label6, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label7, this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "MapPropertiesDialog.label.vision.dist"));
        panel1.add(label7, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label8, this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "MapPropertiesDialog.label.cell.ai"));
        label8.setToolTipText(this.$$$getMessageFromBundle$$$("net/rptools/maptool/language/i18n", "MapPropertiesDialog.label.cell.ai.tooltip"));
        panel1.add(label8, new GridConstraints(6, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        label9.setName("mapPreviewPanel");
        label9.setText("Preview Panel");
        panel8.add(label9, new GridConstraints(0, 0, 4, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
