...
public class TokenVblPanel extends JPanel {
  ...
  public void reset(Token token) {
    ...
    autoGenerated = false;
    tokenVBL_optimized = token.getTopology(Zone.TopologyType.WALL_VBL);
    tokenVBL_original = tokenVBL_optimized;
  ...
  public void setToken(Token token) {
    ...
    final var topology = token.getTopology(Zone.TopologyType.WALL_VBL);
    setTokenVBL_optimized(topology);
    setTokenVBL_original(topology);

    if (token.getColorSensitivity(Zone.TopologyType.WALL_VBL) >= 0) {
      colorSensitivity = token.getColorSensitivity(Zone.TopologyType.WALL_VBL);
    }
  }
