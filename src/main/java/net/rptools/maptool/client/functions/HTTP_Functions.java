 ...
 *
 * <p>postRequest(URL, Parameters) :: Takes a URL as a string and a JSON array of Parameters and
 * sends s POST request, returning HTTP data.
 *
  ...
  public Object childEvaluate(Parser parser, String functionName, List<Object> parameters)
    ...
    if (functionName.equals("postRequest")) {
      ...
      if (!requestURL.startsWith("syrinscape")) {
        ...
        if (parameters.size() == 2) params.put("jsonData", parameters.get(1).toString());
