...
public class MapTool {
    ...
    /**
     * This method looks up the message key in the properties file and returns the resultant text
     * with the detail message from the <code>Throwable</code> appended to the end.
     *
     * @param msgKey
     ...
     * error, a warning, or just an information message. Do not use this method if the desired
     * result is a simple confirmation box (use {@link #confirm(String, Object...)} instead).
     *
     * @param message
     *            the key in the properties file to put in the body of the dialog (formatted using
     *            <code>params</code>)
     * @param titleKey
     *            the key in the properties file to use when creating the title of the dialog window
     *            (formatted using <code>params</code>)
     * @param messageType
     ...
     * <code>messages</code> is stored into a JList and that component is then used as the content
     * of the dialog box. This allows multiple strings to be displayed in a manner consistent with
     * other message dialogs.
     *
     * @param messages
     *            the Objects (normally strings) to put in the body of the dialog; no properties
     *            file lookup is performed!
     * @param titleKey
     *            the key in the properties file to use when creating the title of the dialog window
     *            (formatted using <code>params</code>)
     * @param messageType
     *            one of <code>JOptionPane.ERROR_MESSAGE</code>, <code>
     ...
     * {@link #showMessage(Object[], String, int, Object...)} and passing <code>
     ...
     * {@link #generateMessage(String, Throwable)} and passing it the two parameters. Also logs an
     * entry using the {@link Logger#error(Object, Throwable)} method.
     *
     * <p>
     * The title is the property key <code>"msg.title.messageDialogError"</code> , and the dialog
     ...
     * Displays a dialog box with a predefined title and type, and a message crafted by calling
     * {@link #generateMessage(String, Throwable)} and passing it the two parameters. Also logs an
     * entry using the {@link Logger#warn(Object, Throwable)} method.
     *
     * <p>
     * The title is the property key <code>"msg.title.messageDialogWarning"</code>, and the dialog
    ...
    /**
     * Displays a dialog box by calling {@link #showInformation(String, Throwable)} and passing
     * <code>
     ...
     * Displays a dialog box with a predefined title and type, and a message crafted by calling
     * {@link #generateMessage(String, Throwable)} and passing it the two parameters. Also logs an
     * entry using the {@link Logger#info(Object, Throwable)} method.
     *
     * <p>
     * The title is the property key <code>"msg.title.messageDialogInfo"</code>, and the dialog type
     * is <code>JOptionPane.INFORMATION_MESSAGE</code>.
     *
     * @param msgKey
     *            the key to use when calling {@link I18N#getText(String)}
     * @param t
    ...
    /**
     * This method is specific to deleting a token, but it can be used as a basis for any other
     * method which wants to be turned off via a property.
     *
     ...
     * be called from any uncontrolled macros as there are both security and denial-of-service
     * attacks possible.
     *
     * @param url
     */
    ...
    /**
     * For Multi-monitor support, allows you to move the frame to a specific monitor. It will also
     * set the height, width and x, y position of the frame.
     *
     * @author Jamz
     * @since 1.4.1.0
     * @param frame
    ...
    private static final void configureJide() {
        LookAndFeelFactory.UIDefaultsCustomizer uiDefaultsCustomizer = new LookAndFeelFactory.UIDefaultsCustomizer() {
            public void customize(UIDefaults defaults) {
                ...
                defaults.put("OptionPane.bannerForeground", painter != null ? painter.getOptionPaneBannerForeground() : null); // you
                                                                                                                               // should
                                                                                                                               // adjust
                                                                                                                               // this
                                                                                                                               // if
     ...
     *
     * <p>
     * While MapTool itself doesn't use any Java 6-specific features, we use a couple dozen
     * third-party libraries and a search of those JAR files indicate that <i>they DO use</i> Java
     * 6. So it's best if we warn users that they might be going along happily and suddenly hit a
     * Java runtime error! It might even be something they do every time they run the program, but
     * some piece of data was different and the library took a different path and the Java 6-only
     * method was invoked...
     *
     * <p>
     * This method uses the system property <b>java.specification.version</b> as it seemed the
    ...
    /**
     * Return whether the campaign file has changed. Only checks to see if there is a single empty
     * map with the default name (ZoneFactory.DEFAULT_MAP_NAME). If so, the campaign is "empty". We
     * really should check against things like campaign property changes as well, including campaign
     * macros...
     */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /**
             * ************************************************************************** For
             * TinyLAF 1.3.04 this is how the color was changed for a button.
             */
            // Theme.buttonPressedColor[Theme.style] = new ColorReference(Color.gray);

            /**
             * ************************************************************************** And this
             * is how it's done in TinyLAF 1.4.0 (no idea about the intervening versions).
             */
