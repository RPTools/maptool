...
public class TokenFootprintCreator {
  ...
  private static List<TokenFootprint> makeSquare() {
    List<TokenFootprint> footprintList =
        Arrays.asList(
            // SQUARE
            new TokenFootprint("Fine", false, 0.5),
            new TokenFootprint("Diminutive", false, 0.5),
            new TokenFootprint("Tiny", false, 0.5),
            new TokenFootprint("Small", false, 0.75),
            ...
            new TokenFootprint("5x5 squares", squarePoints(5)),
            new TokenFootprint("Colossal", squarePoints(6)),
            new TokenFootprint("7x7 squares", squarePoints(7)),
            new TokenFootprint("8x8 squares", squarePoints(8)),
            new TokenFootprint("9x9 squares", squarePoints(9)),
            new TokenFootprint("10x10 squares", squarePoints(10)));
