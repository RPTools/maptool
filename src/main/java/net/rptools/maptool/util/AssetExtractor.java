...
/**
 * Appears to be unused within MapTool. What was its original purpose? It appears to be some way to extract individual images from a campaign, but it has multiple problems: always names output images
 * with <b>.jpg</b> extensions, doesn't allow a choice of which images are extracted, doesn't turn on annotation processing for {@link Asset} objects (needed for XStream processing), and doesn't used
