...
/**
 * This class encapsulates methods for requesting a server via HTTP GET/POST and provides methods
 * for parsing response from the server.
 *
 * @author Ha Minh Nam
 */
...
public class HTTPUtil {
  ...
  /**
   * Makes an HTTP request using GET method to the specified URL and returns an input stream that
   * wraps server's response.
   *
  ...
  /**
   * Makes an HTTP request using POST method to the specified URL and returns an input stream that
   * wraps server's response.
   *
   * @param requestURL the URL of the remote server
  ...
  /**
   * Returns only one line from the server's response. This method should be used if the server
   * returns only a single line of String.
   *
  ...
  /**
   * Returns an array of lines from the server's response. This method should be used if the server
   * returns multiple lines of String.
   *
   * @param inputStream the InputStream to parse server's response
