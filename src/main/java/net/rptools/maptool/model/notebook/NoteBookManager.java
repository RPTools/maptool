...
public final class NoteBookManager {
  ...
  /**
   * Register a new zone with the {@code NoteBookManager}.
   *
   * @param zoneId The id of the {@link net.rptools.maptool.model.Zone} that was added.
   */
  public void zoneAdded(GUID zoneId) {
    for (NoteBook noteBook : noteBooks.values()) {
      noteBook.zoneAdded(zoneId);
    }
  }
  /**
   * Deregister a zone with the {@code NoteBookManager}.
   *
   * @param zoneId The id of the {@link net.rptools.maptool.model.Zone} that was removed.
   */
  public void zoneRemoved(GUID zoneId) {
    for (NoteBook noteBook : noteBooks.values()) {
      noteBook.zoneRemoved(zoneId);
    }
  }
}
