...
AppName=Launcher
AppVersion=1.4.1.7
AppVerName=Launcher 1.4.1.7
AppPublisher=RPTools
AppComments=Launcher by RPTools
...
DefaultDirName={localappdata}/Launcher
...
;WinXP or above
MinVersion=0,5.1 
OutputBaseFilename=Launcher-1.4.1.7
Compression=lzma
SolidCompression=yes
PrivilegesRequired=lowest
SetupIconFile=Launcher/Launcher.ico
UninstallDisplayIcon={app}/Launcher.ico
UninstallDisplayName=Launcher
WizardImageStretch=Yes
WizardSmallImageFile=Launcher-setup-icon.bmp
WizardImageFile=/Users/frank/git/RPTools/launcher/package/windows/Launcher-setup.bmp
