...
/**
 * A list of token transfer data that came from the Group Tool. Need to specify app in the class so that drag and drop functionality can check the mime type to see if it supports tokens from that
 * particular app.
 * 
 * @author jgorrell
